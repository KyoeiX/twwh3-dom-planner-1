(function(){
  ...
  function ensureUiStyles(){
    ...
    st.textContent=`
      ...
      .loadCheck span{display:grid;grid-template-columns:minmax(0,1fr) auto auto;align-items:center;gap:8px;min-height:28px;padding:5px 8px;border:1px solid #5e6670;background:#0b0d10;color:#d5b06d;font-size:12px;font-weight:900;text-align:left;line-height:1.1;box-shadow:inset 0 0 10px #000}
      .loadCheck b{min-width:0}.loadCost{font-style:normal;color:#ffd77d;white-space:nowrap}.rowTick{font-style:normal;color:#86e56a;opacity:0;min-width:14px;text-align:right}.loadCheck input:checked+span .rowTick{opacity:1}
      .loadCheck:hover span{border-color:#d6a64c;color:#ffe3a3}.loadCheck input:disabled+span{opacity:.75;cursor:default}
      .loadCheck input:checked+span{border-color:#d6a64c;background:linear-gradient(180deg,#3a1908,#0d0f11);color:#fff1c9;box-shadow:inset 0 0 0 1px #d6a64c,0 0 10px #d6a64c33}
